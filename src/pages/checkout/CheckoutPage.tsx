...
export default function CheckoutPage() {
  const { cart, setCart, showToast } = useOutletContext<{
  ...
  const handlePaymentSubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setIsSuccess(true);
      const generatedOrderId = 'MC-' + Math.floor(100000 + Math.random() * 900000);
      setOrderId(generatedOrderId);
      setCart([]); // Clear cart
      showToast('✨ Payment processed successfully! Order placed.');
    }, 2500);
  };
    ...
    return (
      <div className="checkout-page-wrapper">
        <div className="success-card">
          ...
          <p className="subtitle">Thank you for choosing Mandap-Craft Privilege.</p>
                ...
                <div className="form-fields upi-fields">
                  <div className="qr-box">
                    <div className="qr-visual">
                      {/* Simulated QR block */}
                      <span className="qr-text">MANDAP·CRAFT PAY QR</span>
                    </div>
