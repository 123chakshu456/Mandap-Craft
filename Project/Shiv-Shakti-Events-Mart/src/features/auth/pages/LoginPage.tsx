      ...
      <div className="login-page-wrapper">
        <div className="login-modal">
          <div className="modal-banner">
            <span className="brand-title">SHIV·SHAKTI·EVENTS·MART</span>
            ...
            {isSignUp && (
              <div className="checkbox-group">
                ...
                <label htmlFor="terms-checkbox">
                  I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Shield Charter</a> of Shiv Shakti Events Mart Luxury.
                </label>
              </div>
            )}
