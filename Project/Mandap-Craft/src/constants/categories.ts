  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        popularItems: ['Crimson Red VIP Runner (50m)', 'Royal Blue Velvet Banquet Carpet', 'Seamless White Bridal Aisle Runner', 'Gold Embroidered Welcome Rug'],
      },
      {
        id: 'mats',
        title: 'Mats',
        description: 'High-Density Interlocking Green Turf Mats, Anti-Skid Rubber Mats & Duckboards',
        image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=600&q=80',
        popularItems: ['Artificial Green Lawn Turf Mats', 'Heavy-Duty Anti-Slip Floor Mat', 'Interlocking Event Stage Deck Tiles', 'Waterproof Entrance Coir Mats'],
      },
      {
        id: 'electrical-items',
